...
{
    /// <inheritdoc />
    public partial class OrganizationModelSync : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkLocations_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QRCodes_WorkLocations_WorkLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QRCodes_OrganizationId",
                table: "QRCodes",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_QRCodes_WorkLocationId",
                table: "QRCodes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkLocations_OrganizationId",
                table: "WorkLocations",
                column: "OrganizationId");
