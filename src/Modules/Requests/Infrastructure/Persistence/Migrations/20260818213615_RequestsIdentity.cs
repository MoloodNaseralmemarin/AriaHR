...
{
    /// <inheritdoc />
    public partial class RequestsIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "MissionLocationLogs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrganizationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MissionRequestId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissionLocationLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MissionLocationLogs_MissionRequests_MissionRequestId",
                        column: x => x.MissionRequestId,
                        principalTable: "MissionRequests",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionLocationLogs_MissionRequestId",
                table: "MissionLocationLogs",
                column: "MissionRequestId");
        }
